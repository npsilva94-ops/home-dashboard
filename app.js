...
var EXPENSE_CATS={credit:{name:"Crédito",cls:"cat-credit",color:"#7e9fc1"},supermarket:{name:"Supermercado",cls:"cat-supermarket",color:"#86b28e"},house:{name:"Casa",cls:"cat-house",color:"#d5bd6d"},car:{name:"Carro",cls:"cat-car",color:"#6f9aa8"},health:{name:"Saúde",cls:"cat-health",color:"#c77f89"},gym:{name:"Ginásio",cls:"cat-gym",color:"#8b78a8"},leisure:{name:"Lazer",cls:"cat-leisure",color:"#b48db7"},restaurant:{name:"Restauração",cls:"cat-restaurant",color:"#d59b77"},other:{name:"Outros",cls:"cat-other",color:"#9b9fa3"}};
